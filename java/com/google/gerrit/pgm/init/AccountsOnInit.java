...
public class AccountsOnInit {
  ...
  @Inject
  public AccountsOnInit(InitFlags flags, SitePaths site, AllUsersNameOnInitProvider allUsers, GitRepositoryManagerOnInit repoManager) {
    this.flags = flags;
    this.site = site;
